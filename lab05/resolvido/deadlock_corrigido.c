...
// Resolvi o problema evitando que a espera circular que ocorrece ao colocar as 
// requisições de recursos (sem_wait) em uma ordem padrão para as duas threads.

// Não acontece espera circular ao organizar as requisições de recursos na 
// mesma ordem para as duas threads. Feito dessa forma, é impossível uma
// thread segurar um recurso que outra pode precisar sem antes esbarrar em
// um recurso já ocupado.
